 ...
 * Update.java
 *
 * Created on Sep 12, 2015, 9:07:22 AM
 */
...
public class Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Update Product Information - easyShopping.com");
        ...
        jButton4.setText("Update Amazon Info");
        ...
        jButton6.setText("Update Flipkart Info");
        ...
        jButton5.setText("Update Snapdeal Info");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try
        {
         ...
         String strSQL="UPDATE amazon set Product_Name='"+(PN)+"',Brand='"+(B)+"',MRP='"+(MRP)+"',Price_Offered='"+(PO)+"',Delivery_Time='"+(DT)+"',Mode_Of_Payment='"+(MOP)+"' where Product_ID='"+PID+"';";
         int rowEffected=S.executeUpdate(strSQL);
         if (rowEffected==0)
        ...
        {
            JOptionPane.showMessageDialog(null,"Could Not Update, Please Try Again");
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try
        {
         ...
         String strSQL="UPDATE flipkart set Product_Name='"+(PN)+"',Brand='"+(B)+"',MRP='"+(MRP)+"',Price_Offered='"+(PO)+"',Delivery_Time='"+(DT)+"',Mode_Of_Payment='"+(MOP)+"' where Product_ID='"+PID+"';";
         int rowEffected=S.executeUpdate(strSQL);
         if (rowEffected==0)
         JOptionPane.showMessageDialog(this,"Record Does Not Exist");
         else
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        {
         ...
         String strSQL="UPDATE snapdeal set Product_Name='"+(PN)+"',Brand='"+(B)+"',MRP='"+(MRP)+"',Price_Offered='"+(PO)+"',Delivery_Time='"+(DT)+"',Mode_Of_Payment='"+(MOP)+"' where Product_ID='"+PID+"';";
         int rowEffected=S.executeUpdate(strSQL);
         if (rowEffected==0)
         JOptionPane.showMessageDialog(this,"Record Does Not Exist");
         else
